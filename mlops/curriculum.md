...
- **난이도**: ★★☆
- **시각화 연결**: [모델 성능 모니터링 시각화 보기](part4/IV-1-1.html) — 모니터링 부재 / 4 지표 / 임계치 / 알람 자동화 (건강 검진 대시보드 비유)
- **다음 섹션**: IV-1-2

### Section IV-1-2. 데이터 드리프트 감지
- **난이도**: ★★★
- **시각화 연결**: [데이터 드리프트 시각화 보기](part4/IV-1-2.html) — 드리프트 / PSI / Evidently / 알람·트리거 (기상 캐스터 비유)
- **다음 섹션**: IV-2-1

### Section IV-2-1. Retraining 트리거
- **난이도**: ★★☆
- **시각화 연결**: [Retraining 트리거 시각화 보기](part4/IV-2-1.html) — 수동 / 스케줄 / 임계치 / 이벤트 (자동차 정기 점검 비유)
- **다음 섹션**: IV-2-2

### Section IV-2-2. 거버넌스 & 감사 로그
- **난이도**: ★★★
- **시각화 연결**: [거버넌스 & 감사 시각화 보기](part4/IV-2-2.html) — 책임 부재 / Model Card / 리니지 / 감사 로그 (의료 진료기록 비유)
- **다음 섹션**: V-1-1
